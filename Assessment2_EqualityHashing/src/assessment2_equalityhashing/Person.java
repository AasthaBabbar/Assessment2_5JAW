...
/**
 * Person class includes information of a person
 * like name, address , email and tel number
 */
// Class person
public class Person {
   // properties of the person
     ...
     */
    public Person(String _name, String _telNum, String _email, int bldgNo, String street, String suburb, String state, String postcode)
    {
        id++;
        name = _name;
        telNum = _telNum;
