...
public class Enrollment {
   ...
   public boolean equals(Object obj)
   {
        ...
        return e.dateEnrolled == this.dateEnrolled && (e.grade.equals(this.grade)) && 
...
class SortbyDate implements java.util.Comparator<Enrollment>
{
    
    @Override
    public int compare(Enrollment a, Enrollment b) {
        
        Date first = a.getDateEnrolled();
        Date second = b.getDateEnrolled();
